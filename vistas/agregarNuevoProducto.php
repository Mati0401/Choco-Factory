...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="../img/bd-carga.png" type="image/png">
  <!-- Bootstrap -->
            ...
            <form action="../php/agregar.php" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-12 ubicacion-btn form-group">
                  <button type="submit" class="boton-guardar" name="guardar-producto">Guardar</button>
                </div>
              </div>
            </form>
          </div>
